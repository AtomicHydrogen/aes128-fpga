...
## 12 MHz Clock Signal
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { clk_12 }]; #IO_L12P_T1_MRCC_14 Sch=gclk


## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { arst_buff }]; #IO_L12N_T1_MRCC_16 Sch=led[1]
...
## Buttons
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { arst }]; #IO_L19N_T3_VREF_16 Sch=btn[0]
...
## UART
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { rxd_out }]; #IO_L7N_T1_D10_14 Sch=uart_rxd_out
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { txd_in }]; #IO_L7P_T1_D09_14 Sch=uart_txd_in
